L_FUNC['StrNCat', 1]
L_FUNC['getaddrinfo', 1]
L_FUNC['_ui64toa', 1]
L_FUNC['fclose', 1]
L_FUNC['pthread_mutex_lock', 1]
L_FUNC['gets_s', 1]
L_FUNC['sleep', 1]
...
L_FUNC['_mbstok_s', 1]
L_FUNC['_cprintf_s', 1]
L_FUNC['ldap_search_init_page', 1]
L_FUNC['memmove_s', 1]
L_FUNC['ctime_s', 1]
L_FUNC['vswprintf', 1]

L_FUNC['vswprintf_s', 1]
L_FUNC['_snwprintf', 1]
L_FUNC['_gmtime_s', 1]
L_FUNC['_tccpy', 1]
L_FUNC['*RC6*', 1]
...
L_FUNC['memset', 1]
L_FUNC['syslog', 1]
L_FUNC['_vsnprintf_s', 1]
L_FUNC['HeapAlloc', 1]
L_FUNC['pthread_mutex_destroy', 1]

abd123UNC['ChangeWindowMessageFilter', 1]
abd123UNC['_ultot', 1]
abd123UNC['crypt_r', 1]
abd123UNC['_strupr_s_l', 1]
abd123UNC['LoadLibraryExA', 1]
abd123UNC['_strerror_s', 1]

L_FUNC['LoadLibraryExW', 1]
L_FUNC['wvsprintf', 1]
L_FUNC['MoveFileEx', 1]
L_FUNC['_strdate_s', 1]
L_FUNC['SHA1', 1]
