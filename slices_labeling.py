...
# 레이블링이 지금 제대로 안되는데?
def process_label(label_info, slice_json_files, labeled_slices_dir):
    ...
    for slice_json_file in slice_json_files:
        ...
        if modified:
            new_file_path = labeled_slices_dir / f"labeled_{slice_json_file.name}"
